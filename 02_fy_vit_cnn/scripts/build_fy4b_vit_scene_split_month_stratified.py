...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-dir", type=Path, default=FY_ROOT / "data_raw", help="Directory with FY4B HDF/NC files.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=FY_ROOT / "data_processed/fy4b_vit_month_stratified_scene_split",
